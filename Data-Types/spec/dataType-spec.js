...
describe("Data types tests ", function() {
  ...
  describe("Case for Objects. Return an array containing the keys of object.", function() {
    ...
    it("should return ['taiwo', 'kehinde', 'idowu'] for { taiwo: 'male', kehinde: 'female', idowu: undefined }", function() {
      expect(dataTypes({ taiwo: 'male', kehinde: 'female', idowu: undefined })).toEqual(['taiwo', 'kehinde', 'idowu']);
    });
